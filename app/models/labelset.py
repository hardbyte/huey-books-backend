...
class LabelOrigin(CaseInsensitiveStringEnum):
    ...
    HUMAN = "HUMAN"  # Human-provided (Wriveted staff)
    EDUCATOR = "EDUCATOR"  # Human-provided by a teacher reviewing their school's books
...
class LabelSet(Base):
    ...
    def get_label_dict(self, session: Any) -> Dict[str, Any]:
        ...
        label_dict["recommend_status"] = (
            self.recommend_status.value if self.recommend_status else None
        )
